...
<script type="text/javascript">
	window.onload = function() {
		btn1.addEventListener('click',function(){
			...
			//리터럴을 잉요한 정규 표현식 객체 생성
			//패턴양쪽에 /로 작성한다.(시작 기호, 종료기호)
			let regExp1 = /script/;
            ...
            */
            ...
            //위와 같은 말
            //area1.innerHTML += "num.test('0123') : " + num.test('0123') + "<br>";
            console.log("num.test('0123aa')",num.test('0123aa'));
            
            console.log("num1.test('0123')",num.test('0123'));
            console.log("num1.test('0123aa')",num.test('0123aa'));
            ...
            */
            let phone = /\{3}-\d{4}-\d{3}$/;
            console.log('phone1 : ',phone.test('000-0000-000'));
            ...
            */
            ...
            console.log('email',email.test('yoonyeji12@naver.com'));
            console.log('email',email.test('yoonyeji12naver.com'));
            console.log('email',email.test('yoonyeji12@navercom'));
            /*
			//박스안에 출력하기
