...
<!-- 
	    ...
	    테스트 방법 : 서버에 컨텍스트 루트를 지정하고 테스트를 해봅시다.
 -->
...
<a href="${root }/09JSTL/inc/otherPage.jsp">외부페이지로 바로 가기 -request.getContextPath사용 </a>

<h2>예외처리</h2>
<!-- 
c: catch태그 예외가 발생하면 지정한 변수에 여러 에러메시지가 저장되어 전달
 -->
<%
	int i = 100;
%>
